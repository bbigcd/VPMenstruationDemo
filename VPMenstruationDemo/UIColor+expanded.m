...
@implementation UIColor (AppCorlorExpanded)
+ (UIColor *)appMainCorlor {//APP主颜色
    return [UIColor colorWithHexString:@"16cedb"];
}
+ (UIColor *)bloodMainCorlor {//血压
    return [UIColor colorWithHexString:@"ff9800"];
}
+ (UIColor *)heartMainCorlor {//心率
    return [UIColor colorWithHexString:@"ff307e"];
}
+ (UIColor *)stepMainCorlor {//记步
    return [UIColor colorWithHexString:@"2695f0"];
}
+ (UIColor *)sleepMainCorlor {//睡眠
    return [UIColor colorWithHexString:@"6074bf"];
}

+ (UIColor *)oxygenMainCorlor {//血氧
    return [UIColor colorWithHexString:@"40c4ff"];
}

+ (UIColor *)fatigueMainCorlor {
    return [UIColor colorWithHexString:@"795548"];
}
